...
def get_args():
    parser = argparse.ArgumentParser(
        description="Divide files into subfolders for mpi", formatter_class=argparse.ArgumentDefaultsHelpFormatter
    )
...
def main():
    ...
    if args.output_dir is None:
        args.output_dir = os.path.abspath(args.input_dir) + "_" + str(args.n_cpus)
